...
try:
    ...
    raise RuntimeError("Error: Metadata file 'metadata.pkl' not found.")

documents = df.get('combined_text', []).tolist()
...
def search_faiss(query, top_k=10):
    ...
    try:
        ...
        print(f"FAISS Distances: {distances}")  # Debugging output
        print(f"FAISS Indices: {indices}")  # Debugging output
